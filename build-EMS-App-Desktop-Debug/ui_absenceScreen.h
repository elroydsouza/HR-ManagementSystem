...
"QPushButton::pressed { background-color: rgb(48, 152, 185); }"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("../../alert.png"), QSize(), QIcon::Normal, QIcon::Off);
        btn_outstandingReq->setIcon(icon2);
...
""));
        ...
        btn_outstandingApp->setIcon(icon3);
...
"QPushButton::pressed { background-color: rgb(48, 152, 185); }"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("../../ask-for-help.png"), QSize(), QIcon::Normal, QIcon::Off);
        btn_maintenance->setIcon(icon4);
